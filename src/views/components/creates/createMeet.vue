<template>
    <v-layout wrap>
        <v-flex xs12 sm12 md12 lg12 xl12>
            <v-text-field placeholder="What are you meeting about?"></v-text-field>
        </v-flex>
        <v-flex xs12 sm12 md12 lg12 xl12>
            <v-layout row wrap>
                ...
                <v-flex xs6 sm5 md6 lg7 xl7>
                    <p>Start time</p>
                    <v-layout row style="margin-top: -5%">
                        <v-flex xs6 sm6 md6 lg8 xl8>
                        ...
                        <v-flex xs6 sm6 md6 lg4 xl4>
                            <v-dialog ref="dialog" v-model="modal2" :return-value.sync="time" persistent lazy full-width
                                width="290px">
                                <template v-slot:activator="{ on }">
                                    <v-text-field v-model="time" label="Times" prepend-icon="access_time" readonly
                                        v-on="on">
                                    </v-text-field>
                                </template>
                ...
                <v-flex xs6 sm3 md2 lg2 xl2 offset-lg1 offset-xl1>
                    <p>Duration</p>
                    <v-menu :close-on-content-click="false" :nudge-width="200" offset-y>
                        <template v-slot:activator="{ on }">
                            <a color="indigo" v-on="on">
